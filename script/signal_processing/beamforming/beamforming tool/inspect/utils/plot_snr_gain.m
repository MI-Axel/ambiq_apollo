function plot_snr_gain( BF, ratiosdB )
%plot_snr_gain plot SNR gain given beamformer struct with computed weights
%and ratio of uncorrelated to diffuse noise (in dB)
