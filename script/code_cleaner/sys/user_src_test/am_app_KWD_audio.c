...
#endif    // VOS_configUSE_SENSORY_THF_ONLY||VOS_configUSE_Sensory_THF
...
#endif    // VOS_configUSE_Sensory_THF
...
#else    // (VOS_configUSE_2CM_FBF_SCNR_0_5_PREROLL==1)
...
#endif    // (VOS_configUSE_BLE||VOS_configUSE_AUDIO_CODEC)
...
#endif    // (VOS_configUSE_RTT_RECORDER&&VOS_configUSE_RECORD_FULL_FILTER)
