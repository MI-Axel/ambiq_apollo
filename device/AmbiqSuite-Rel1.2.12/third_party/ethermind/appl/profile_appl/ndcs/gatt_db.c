 ...
 *  ========+====================+==================+=====================
 *  0x000F  |       0x2800       | Rd               | 0x1807
 *  --------+--------------------+------------------+---------------------
 *  0x0010  |       0x2803       | Rd               | 0x02, 0x0011, 0x2A11
 *  --------+--------------------+------------------+---------------------
 *  0x0011  |       0x2A11       | Rd               | 0.0
 */
...
#if ((defined NDCS) && (defined GATT_DB))
...
DECL_CONST UCHAR gatt_const_uuid_arr[GATT_UUID_ARRAY_SIZE] =
{
    ...
    /* 34 - NextDSTChangeService Service UUID */
    0x07, 0x18,

    /* 36 - TimeWithDST Characteristic UUID */
    0x11, 0x2A,
...
DECL_CONST UCHAR gatt_const_value_arr[GATT_CONST_VALUE_ARRAY_SIZE] =
{
    ...
    /* 42 - TimeWithDST(4); Property: 0x02, Value Handle: 0x0011, UUID: 0x2A11 */
    0x02, 0x11, 0x00, 0x11, 0x2A,
};
...
DECL_CONST GATT_DB_DESC_DATA gatt_db_attr_table[GATT_DB_MAX_ATTRIBUTES] =
{
    ...
    /* Handle - 0x000F */
    /* 3 - NextDSTChangeService - Service Declaration */
    {
        /* Property */
        GATT_DB_READ,
    ...
    /* Handle - 0x0010 */
    /* 4 - TimeWithDST - Characteristic Declaration */
    {
        /* Property */
        GATT_DB_READ,
    ...
    /* Handle - 0x0011 */
    /* 4 - TimeWithDST - Characteristic Value */
    {
        /* Property */
        GATT_DB_READ,
...
#endif /* ((defined NDCS) && (defined GATT_DB)) */
