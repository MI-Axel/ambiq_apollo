 ...
 *  \file appl_hidh.c
 *
 *  This is a stand-alone sample application for HID Host.
 *
...
#define APPL_HID_EXT_REPORT_REF_DESC_UUID                      0x2907
#define APPL_HID_REPORT_REF_DESC_UUID                          0x2908

#define APPL_MAX_SERVICE_INSTANCES                             2
#define APPL_INPUT_REPORT_TYPE                                 1
#define APPL_OUTPUT_REPORT_TYPE                                2
#define APPL_FEATURE_REPORT_TYPE                               3
/* ----------------------------------------- Macro Defines */
...
/** HIDH Characteristic related information */
typedef struct
{
    /* DIS - Device Information Service */

     /* Manufacturer Name */
     ATT_ATTR_HANDLE dis_manufacturer_name_hdl;

     /* Model Number */
     ATT_ATTR_HANDLE dis_model_number_hdl;

     /* Serial Number */
     ATT_ATTR_HANDLE dis_serial_number_hdl;

     /* Hardware Revision */
     ATT_ATTR_HANDLE dis_hardware_revision_hdl;

     /* Firmware Revision */
     ATT_ATTR_HANDLE dis_firmware_revision_hdl;

     /* Software Revision */
     ATT_ATTR_HANDLE dis_software_revision_hdl;

     /* System Id */
     ATT_ATTR_HANDLE dis_sys_id_hdl;

     /* RegCertDataList */
     ATT_ATTR_HANDLE dis_reg_cert_data_list_hdl;

    /* HIDS - HID Service */
    /* Protocol Mode */
    ATT_ATTR_HANDLE proto_mode_hdl;

    /* Report */
    ATT_ATTR_HANDLE in_report_hdl;
    ATT_ATTR_HANDLE out_report_hdl;
    ATT_ATTR_HANDLE feature_report_hdl;

    /* Report - CCCD */
    ATT_ATTR_HANDLE in_report_ref_hdl;
    ATT_ATTR_HANDLE out_report_ref_hdl;
    ATT_ATTR_HANDLE feature_report_ref_hdl;

    /* Report - CCCD */
    ATT_ATTR_HANDLE in_report_ccc_hdl;

    /* Report Map */
    ATT_ATTR_HANDLE report_map_hdl;

    /* Boot Keyboard Input Report */
    ATT_ATTR_HANDLE boot_kb_in_report_hdl;

    /* Boot Keyboard Input Report - CCCD */
    ATT_ATTR_HANDLE boot_kb_in_report_ccc_hdl;

    /* Boot Keyboard Output Report */
    ATT_ATTR_HANDLE boot_kb_out_report_hdl;

    /* Boot Mouse Input Report */
    ATT_ATTR_HANDLE boot_mus_in_report_hdl;

    /* Boot Mouse Input Report - CCCD */
    ATT_ATTR_HANDLE boot_mus_in_report_ccc_hdl;
    ...
    ATT_ATTR_HANDLE hid_ext_rprt_ref_desc_hdl;
    ...
    /* Battery Level - CCCD */
    ATT_ATTR_HANDLE bas_batt_level_ccc_hdl;

    /* DIS - Device Information Service */

    /* PnP ID */
    ATT_ATTR_HANDLE dis_pnp_id_hdl;
...
#define APPL_HID_GET_SERV_END_HANDLE(i)    service_range_list[(i)].end_handle

#define DIS_MANUFACTURER_NAME_HDL     (hidh_char_info.dis_manufacturer_name_hdl)

/* Model Number */
#define DIS_MODEL_NUMBER_HDL          (hidh_char_info.dis_model_number_hdl)

/* Serial Number */
#define DIS_SERIAL_NUMBER_HDL         (hidh_char_info.dis_serial_number_hdl)

/* Hardware Revision */
#define DIS_HARDWARE_REVISION_HDL     (hidh_char_info.dis_hardware_revision_hdl)

/* Firmware Revision */
#define DIS_FIRMWARE_REVISION_HDL     (hidh_char_info.dis_firmware_revision_hdl)

/* Software Revision */
#define DIS_SOFTWARE_REVISION_HDL     (hidh_char_info.dis_software_revision_hdl)

/* System Id */
#define DIS_SYSTEM_ID_HDL             (hidh_char_info.dis_sys_id_hdl)

/* RegCertDataList */
#define DIS_REG_CERT_DATA_LIST_HDL    (hidh_char_info.dis_reg_cert_data_list_hdl)

/* HIDS - HID Service */
/* Protocol Mode */
#define HIDS_PROTO_MODE_HDL         (hidh_char_info.proto_mode_hdl)

/* Report */
#define HIDS_INPUT_REPORT_HDL       (hidh_char_info.in_report_hdl)
#define HIDS_OUTPUT_REPORT_HDL      (hidh_char_info.out_report_hdl)
#define HIDS_FEATURE_REPORT_HDL     (hidh_char_info.feature_report_hdl)

/* Report Reference descriptor */
#define HIDS_INPUT_REPORT_REF_HDL   (hidh_char_info.in_report_ref_hdl)
#define HIDS_OUTPUT_REPORT_REF_HDL  (hidh_char_info.out_report_ref_hdl)
#define HIDS_FEATURE_REPORT_REF_HDL (hidh_char_info.feature_report_ref_hdl)

/* Input Report - CCCD  */
#define HIDS_INPUT_REPORT_CCC_HDL   (hidh_char_info.in_report_ccc_hdl)

/* Report Map */
#define HIDS_REPORT_MAP_HDL         (hidh_char_info.report_map_hdl)

/* Boot Keyboard Input Report */
#define HIDS_BOOT_KB_IN_REPORT_HDL  (hidh_char_info.boot_kb_in_report_hdl)

/* Boot Keyboard Input Report - CCCD */
#define HIDS_BOOT_KB_IN_REPORT_CCC_HDL (hidh_char_info.boot_kb_in_report_ccc_hdl)
#define APPL_HID_GET_SERV_END_HANDLE(i)    service_range_list[(i)].end_handle
/* Boot Keyboard Output Report */
#define HIDS_BOOT_KB_OUT_REPORT_HDL (hidh_char_info.boot_kb_out_report_hdl)

/* Boot Mouse Input Report */
#define HIDS_BOOT_MUS_IN_REPORT_HDL (hidh_char_info.boot_mus_in_report_hdl)

/* Boot Mouse Input Report - CCCD */
#define HIDS_BOOT_MUS_IN_REPORT_CCC_HDL (hidh_char_info.boot_mus_in_report_ccc_hdl)

/* HID Information */
#define HIDS_HID_INFO_HDL           (hidh_char_info.hid_info_hdl)

/* HID Control Point */
#define HIDS_HID_CP_HDL             (hidh_char_info.hid_cp_hdl)

#define HIDS_EXT_REPORT_REF_DESC_HDL    (hidh_char_info.hid_ext_rprt_ref_desc_hdl)

/* BAS - Battery Service */

/* Battery Level */
#define BAS_BATTERY_LEVEL_HDL       (hidh_char_info.bas_batt_level_hdl)

#define BAS_BATTERY_LEVEL_CCC_HDL   (hidh_char_info.bas_batt_level_ccc_hdl)

/* DIS - Device Information Service */

/* PnP ID */
#define DIS_PNP_ID_HDL              (hidh_char_info.dis_pnp_id_hdl)

#define APPL_CLI_CNFG_VAL_LENGTH    2

#define APPL_HIDH_INFO_INIT()\
        DIS_MANUFACTURER_NAME_HDL    = ATT_INVALID_ATTR_HANDLE_VAL;\
        DIS_MODEL_NUMBER_HDL         = ATT_INVALID_ATTR_HANDLE_VAL;\
        DIS_SERIAL_NUMBER_HDL        = ATT_INVALID_ATTR_HANDLE_VAL;\
        DIS_HARDWARE_REVISION_HDL    = ATT_INVALID_ATTR_HANDLE_VAL;\
        DIS_FIRMWARE_REVISION_HDL    = ATT_INVALID_ATTR_HANDLE_VAL;\
        DIS_SOFTWARE_REVISION_HDL    = ATT_INVALID_ATTR_HANDLE_VAL;\
        DIS_SYSTEM_ID_HDL            = ATT_INVALID_ATTR_HANDLE_VAL;\
        HIDS_PROTO_MODE_HDL         = ATT_INVALID_ATTR_HANDLE_VAL;\
        HIDS_INPUT_REPORT_HDL       = ATT_INVALID_ATTR_HANDLE_VAL;\
        HIDS_OUTPUT_REPORT_HDL      = ATT_INVALID_ATTR_HANDLE_VAL;\
        HIDS_FEATURE_REPORT_HDL     = ATT_INVALID_ATTR_HANDLE_VAL;\
        HIDS_INPUT_REPORT_REF_HDL   = ATT_INVALID_ATTR_HANDLE_VAL;\
        HIDS_OUTPUT_REPORT_REF_HDL  = ATT_INVALID_ATTR_HANDLE_VAL;\
        HIDS_FEATURE_REPORT_REF_HDL = ATT_INVALID_ATTR_HANDLE_VAL;\
        HIDS_INPUT_REPORT_CCC_HDL   = ATT_INVALID_ATTR_HANDLE_VAL;\
        HIDS_REPORT_MAP_HDL         = ATT_INVALID_ATTR_HANDLE_VAL;\
        HIDS_BOOT_KB_IN_REPORT_HDL  = ATT_INVALID_ATTR_HANDLE_VAL;\
        HIDS_BOOT_KB_IN_REPORT_CCC_HDL  = ATT_INVALID_ATTR_HANDLE_VAL;\
        HIDS_BOOT_KB_OUT_REPORT_HDL = ATT_INVALID_ATTR_HANDLE_VAL;\
        HIDS_BOOT_MUS_IN_REPORT_HDL = ATT_INVALID_ATTR_HANDLE_VAL;\
        HIDS_BOOT_MUS_IN_REPORT_CCC_HDL = ATT_INVALID_ATTR_HANDLE_VAL;\
        HIDS_HID_INFO_HDL           = ATT_INVALID_ATTR_HANDLE_VAL;\
        HIDS_HID_CP_HDL             = ATT_INVALID_ATTR_HANDLE_VAL;\
        HIDS_EXT_REPORT_REF_DESC_HDL = ATT_INVALID_ATTR_HANDLE_VAL;\
        BAS_BATTERY_LEVEL_HDL       = ATT_INVALID_ATTR_HANDLE_VAL;\
        BAS_BATTERY_LEVEL_CCC_HDL   = ATT_INVALID_ATTR_HANDLE_VAL;\
        DIS_PNP_ID_HDL              = ATT_INVALID_ATTR_HANDLE_VAL;\
        hidh_read_info.hdl = ATT_INVALID_ATTR_HANDLE_VAL;\
        hidh_read_info.offset = 0;
...
DECL_STATIC ATT_HANDLE_RANGE service_range_list[APPL_MAX_SERVICE_INSTANCES];
DECL_STATIC UCHAR appl_cur_service_inst;
DECL_STATIC UCHAR service_count;
DECL_STATIC UCHAR appl_reprt_ref_handle_flag;
DECL_STATIC APPL_CHARACTERISTIC appl_char[APPL_MAX_CHARACTERISTICS];
DECL_STATIC ATT_ATTR_HANDLE hid_report_ref_handle_list[3];
DECL_STATIC UCHAR appl_rprt_ref_hndl_count;

DECL_STATIC APPL_SERVICE_DISCOVERY_STATE appl_gatt_dscvry_state;

DECL_STATIC HIDH_CHAR_INFO hidh_char_info;

DECL_STATIC HIDH_READ_INFO  hidh_read_info;
...
"\n\
   ...
   12 - Discover HID Characterisitics\n\
   13 - Read Report Map\n\
   ...
   50 - Discover Device Information Service\n\
   51 - Read PnP ID\n\n\
   --- Battery Service ---\n\
   60 - Discover Battery Service\n\
   61 - Read Battery Level\n\
   62 - Read Battery Level CCD\n\n\
\
Your Option?\n\
";
#else /* BT_SW_TXP */
const char menu[] = " \r\n\
========= HIDH : M A I N   M E N U ========= \r\n\
 \r\n\
    0. Exit \r\n\
    1. Refresh \r\n\
 \r\n\
    ...
    case HCI_COMMAND_COMPLETE_EVENT:
        ...
        else if (HCI_LE_SET_SCAN_PARAMETERS_OPCODE == value_2)
        {
            ...
            if (API_SUCCESS == status)
            {
                 ...
                 */
#else
            CONSOLE_OUT("Set Scan Params Complete. Status: 0x%02X\n", status);
...
API_RESULT appl_read_multiple_req (void)
{
    ATT_READ_MULTIPLE_REQ_PARAM read_mul_req_param;
    API_RESULT retval;

    read_mul_req_param.handle_list = &hid_report_ref_handle_list[0];
    read_mul_req_param.list_count = appl_rprt_ref_hndl_count;
    ...
    APPL_TRC (
    "[APPL]: ATT Read Multiple Request Sent with retval 0x%04X\n",
    retval);
...
void appl_initiate_descriptor_discovery (void)
{
    ...
    if (0 != APPL_GET_CHAR_COUNT())
    {
        do
        {
            ...
            {
                range.end_handle = APPL_HID_GET_SERV_END_HANDLE(appl_cur_service_inst);
            }
            else
            {
                range.end_handle =
        ...
        if (APPL_GET_CURRENT_CHAR_INDEX() == APPL_GET_CHAR_COUNT())
        {
            ...
            if (BT_FALSE != appl_reprt_ref_handle_flag)
            {
                appl_read_req (hidh_read_info.hdl);
            }
...
void appl_handle_read_response (UCHAR * data, UINT16 datalen)
{
    if (BT_FALSE != appl_reprt_ref_handle_flag)
    {
        switch (data[1])
        {
            case APPL_INPUT_REPORT_TYPE:
                HIDS_INPUT_REPORT_REF_HDL = hidh_read_info.hdl;
                break;
            case APPL_OUTPUT_REPORT_TYPE:
                HIDS_OUTPUT_REPORT_REF_HDL = hidh_read_info.hdl;
                break;
            case APPL_FEATURE_REPORT_TYPE:
                HIDS_FEATURE_REPORT_REF_HDL = hidh_read_info.hdl;
                break;
            default:
                break;
        }
        appl_reprt_ref_handle_flag = BT_FALSE;
    }
    if ((ATT_DEFAULT_MTU - 1) == datalen)
    {
        ATT_READ_BLOB_REQ_PARAM read_blob_req;

        /* Save the length of data read */
        hidh_read_info.offset += datalen;

        read_blob_req.handle = hidh_read_info.hdl;
        read_blob_req.offset = hidh_read_info.offset;
...
void appl_handle_find_by_type_val_rsp (UCHAR * data, UINT16 datalen)
{
    ...
    if (4 <= datalen)
    {
        if (4 < datalen)
        {
            APPL_TRC ("** Multiple Services Found **\n");
        }

        APPL_TRC ("Start Handle        End Handle\n");

        for (index = 0; index < datalen; index+=4)
        {
            ...
            if (GATT_HID_SERVICE == APPL_CURRENT_SERVICE_UUID())
            {
                service_range_list[service_count].start_handle =\
                    service_start_handle;
                service_range_list[service_count].end_handle =\
                    service_end_handle;
                APPL_HID_GET_SERV_END_HANDLE(service_count) = service_end_handle;
            }
            else
            {
                appl_cur_service_inst = 0;
                range.start_handle = service_start_handle;
                range.end_handle = service_end_handle;
                APPL_HID_GET_SERV_END_HANDLE(0) = service_end_handle;
            }
    ...
    if(0 < length)
    {
        if(0x01 == type)
        {
            ...
            for(index = 0; index<length; index=index+4)
            {
                ...
                {
                    if (GATT_MOUSE_IP_CHARACTERISTIC == APPL_CHAR_GET_UUID(APPL_GET_CURRENT_CHAR_INDEX()))
                    {
                        HIDS_BOOT_MUS_IN_REPORT_CCC_HDL = handle;
                    }
                    else if (GATT_BOOT_KYBRD_IN_RPT_CHARACTERISTIC == APPL_CHAR_GET_UUID(APPL_GET_CURRENT_CHAR_INDEX()))
                    {
                        HIDS_BOOT_KB_IN_REPORT_CCC_HDL = handle;
                    }
                    else if (GATT_HID_RPT_CHARACTERISTIC == APPL_CHAR_GET_UUID(APPL_GET_CURRENT_CHAR_INDEX()))
                    {
                        HIDS_INPUT_REPORT_CCC_HDL = handle;
                    }
                    else if (GATT_BATTERY_LEVEL_CHARACTERISTIC == APPL_CHAR_GET_UUID(APPL_GET_CURRENT_CHAR_INDEX()))
                    {
                        BAS_BATTERY_LEVEL_CCC_HDL = handle;
                    }
                }
                else if (APPL_HID_EXT_REPORT_REF_DESC_UUID == uuid)
                {
                    HIDS_EXT_REPORT_REF_DESC_HDL = handle;
                }
                else if (APPL_HID_REPORT_REF_DESC_UUID == uuid)
                {
                    appl_reprt_ref_handle_flag = BT_TRUE;
                    hidh_read_info.hdl = handle;
                }
            }
        }
     ...
     )
{
    ...
    for (index = 0; index < (unsigned)(data_len/(data_elem_size)); index++ )
    {
        ...
        if (APPL_GD_IN_CHAR_DSCVRY_STATE == APPL_GET_CURRENT_DSCVRY_STATE())
        {
            ...
            case GATT_HID_PROTO_MODE_CHARACTERISTIC:
                HIDS_PROTO_MODE_HDL = value_handle;
                break;

            case GATT_HID_RPT_CHARACTERISTIC:
                if (GATT_DB_CHAR_NOTIFY_PROPERTY == (c_property & GATT_DB_CHAR_NOTIFY_PROPERTY))
                {
                    HIDS_INPUT_REPORT_HDL = value_handle;
                }
                else if (GATT_DB_CHAR_WRITE_WITHOUT_RSP_PROPERTY == (c_property & GATT_DB_CHAR_WRITE_WITHOUT_RSP_PROPERTY))
                {
                    HIDS_OUTPUT_REPORT_HDL = value_handle;
                }
                else
                {
                    HIDS_FEATURE_REPORT_HDL = value_handle;
                }
                break;

            case GATT_HID_RPT_MAP_CHARACTERISTIC:
                HIDS_REPORT_MAP_HDL = value_handle;
                break;

            case GATT_BOOT_KYBRD_IN_RPT_CHARACTERISTIC:
                HIDS_BOOT_KB_IN_REPORT_HDL = value_handle;
                break;

            case GATT_BOOT_KYBRD_OP_CHARACTERISTIC:
                HIDS_BOOT_KB_OUT_REPORT_HDL = value_handle;
                break;

            case GATT_MOUSE_IP_CHARACTERISTIC:
                HIDS_BOOT_MUS_IN_REPORT_HDL = value_handle;
                break;

            case GATT_HID_INFO_CHARACTERISTIC:
                HIDS_HID_INFO_HDL = value_handle;
                break;

            case GATT_HID_CP_CHARACTERISTIC:
                HIDS_HID_CP_HDL = value_handle;
                break;

            case GATT_MANUFACTURER_NAME_CHARACTERISTIC:
                DIS_MANUFACTURER_NAME_HDL = value_handle;
                break;

            case GATT_MODEL_NUMBER_CHARACTERISTIC:
                DIS_MODEL_NUMBER_HDL = value_handle;
                break;

            case GATT_SERIAL_NUMBER_CHARACTERISTIC:
                DIS_SERIAL_NUMBER_HDL = value_handle;
                break;

            case GATT_HARDWARE_REV_CHARACTERISTIC:
                 DIS_HARDWARE_REVISION_HDL = value_handle;
                 break;

            case GATT_FIRMWARE_REV_CHARACTERISTIC:
                 DIS_FIRMWARE_REVISION_HDL = value_handle;
                 break;

            case GATT_SOFTWARE_REV_CHARACTERISTIC:
                 DIS_SOFTWARE_REVISION_HDL = value_handle;
                 break;

            case GATT_SYSTEM_ID_CHARACTERISTIC:
                 DIS_SYSTEM_ID_HDL = value_handle;
                 break;

            case GATT_REG_CERT_DATA_CHARACTERISTIC:
                 DIS_REG_CERT_DATA_LIST_HDL = value_handle;
                 break;

           case GATT_PNP_ID_CHARACTERISTIC:
            DIS_PNP_ID_HDL = value_handle;
            break;
    ...
    if (1 == search_again)
    {
        if (value_handle < APPL_HID_GET_SERV_END_HANDLE(appl_cur_service_inst))
        {
           ...
           )
{
    ...
    *att_handle, event_type, event_result);
    ...
    case ATT_READ_MULTIPLE_RSP:
        APPL_TRC (
        "Received Read Multiple Response with Result 0x%04X!\n",
        event_result);
        break;
    ...
    case ATT_READ_RSP:    /* Fall Through */
    case ATT_READ_BLOB_RSP:
        APPL_TRC ("Received Read Response Opcode!\n");
 ...
 *  \return   : None.
 */
void appl_discover_hid_service(void)
{
    ATT_UUID16             uuid16;

    uuid16 = GATT_HID_SERVICE;

    /* Discovery HID Service */
    appl_discover_service
    (
        &uuid16,
        ATT_16_BIT_UUID_FORMAT
 ...
 *  \return   : None.
 */
void appl_discover_device_info_service(void)
{
    ATT_UUID16             uuid16;

    uuid16 = GATT_DEVICE_INFO_SERVICE;

    /* Discovery HT Service */
    appl_discover_service
    (
        &uuid16,
        ATT_16_BIT_UUID_FORMAT
...
void appl_discover_hid_characterisitcs()
{
    unsigned char  index = 0;
    UINT32 read;
    APPL_TRC ("Discover Characteristics for HID Instance:\n");
    ...
    for (index= 0; index < service_count; index++)
    {
        ...
        APPL_TRC ("   %d     -     0x%04X    |     0x%04X\n",index,
            service_range_list[index].start_handle,
            service_range_list[index].end_handle);
    }

    APPL_TRC ("Select the range for characteristics discovery:");
    fflush (stdout);
    CONSOLE_IN ( "%d",&read);
    appl_cur_service_inst = (UCHAR) read;

    APPL_GET_CHAR_COUNT() = 0;

    appl_att_read_by_type
    (
        &service_range_list[appl_cur_service_inst],
        GATT_CHARACTERISTIC
    );
...
void appl_profile_operations (void)
{
    ...
    while (1)
    {
        ...
        case 1:
            break;
        case 10:
            appl_discover_hid_service();
            break;

        case 11:
            att_range.start_handle = 0x0001;
            att_range.end_handle = 0xFFFF;
            appl_att_read_by_type
            (
                &att_range,
                GATT_INCLUDE
        ...
        case 12:
            appl_discover_hid_characterisitcs();
            break;

        case 13:
            appl_read_req (HIDS_REPORT_MAP_HDL);
            break;

        case 14:
            appl_read_req (HIDS_EXT_REPORT_REF_DESC_HDL);
            break;

        case 15:
            appl_read_req (HIDS_INPUT_REPORT_HDL);
            break;

        case 16:
            appl_read_req (HIDS_INPUT_REPORT_REF_HDL);
            break;

        case 17:
            appl_read_req (HIDS_INPUT_REPORT_CCC_HDL);
            break;

        case 18:
            appl_read_req (HIDS_OUTPUT_REPORT_HDL);
            break;

        case 19:
            appl_read_req (HIDS_OUTPUT_REPORT_REF_HDL);
            break;

        case 20:
            appl_read_req (HIDS_FEATURE_REPORT_HDL);
            break;

        case 21:
            appl_read_req (HIDS_FEATURE_REPORT_REF_HDL);
            break;

        case 22:
            appl_read_req (HIDS_HID_INFO_HDL);
            break;

        case 23:
            appl_read_req (HIDS_BOOT_KB_IN_REPORT_HDL);
            break;

        case 24:
            appl_read_req (HIDS_BOOT_KB_IN_REPORT_CCC_HDL);
            break;

        case 25:
            appl_read_req (HIDS_BOOT_KB_OUT_REPORT_HDL);
            break;

        case 26:
            appl_read_req (HIDS_BOOT_MUS_IN_REPORT_HDL);
            break;

        case 27:
            appl_read_req (HIDS_BOOT_MUS_IN_REPORT_CCC_HDL);
            break;

        case 28:
            appl_read_req (HIDS_PROTO_MODE_HDL);
            break;
        ...
        case 29:
            ...
            att_value.len = 1;
            att_value.val = (UCHAR*)ccc_value;

            appl_write_req
            (
               HIDS_INPUT_REPORT_HDL,
               &att_value
            );
            break;
       ...
       case 32:
           ...
           appl_write_req
           (
               HIDS_FEATURE_REPORT_HDL,
               &att_value
           );
           break;

        case 33:
            printf ("Select Protocol Mode. 0 (Boot), 1 (Report)\n");
            scanf ("%d", &choice);

            proto_mode = (UCHAR)choice;

            value.len = sizeof(proto_mode);
            value.val = (UCHAR*)&proto_mode;
        ...
        case 36:
            ...
            appl_write_req
            (
               HIDS_BOOT_MUS_IN_REPORT_HDL,
               &att_value
            );
            break;

        case 37:
            printf ("Select Control Point Operation. 0 (Suspend), 1 (Exit Suspend)\n");
            scanf ("%d", &choice);

            cp_operation = (UCHAR)choice;

            value.len = sizeof(cp_operation);
            value.val = (UCHAR*)&cp_operation;
        ...
        case 38:
            ...
            ccc_value[0] = (UCHAR)choice;
            ccc_value[1] = 0x00;

            value.len = 2;
            value.val = (UCHAR*)ccc_value;

            appl_write_req
            (
                HIDS_INPUT_REPORT_CCC_HDL,
                &value
            );
            break;
        ...
        case 39:
            ...
            appl_write_req
            (
                HIDS_BOOT_KB_IN_REPORT_CCC_HDL,
                &value
            );
            break;
        ...
        case 40:
            ...
            appl_write_req
            (
                HIDS_BOOT_MUS_IN_REPORT_CCC_HDL,
                &value
            );
            break;

        case 50:
            appl_discover_device_info_service ();
            break;

        case 51:
            appl_read_req (DIS_PNP_ID_HDL);
            break;
        ...
        case 61:
            ...
            break;
        case 62:
            appl_read_req (BAS_BATTERY_LEVEL_CCC_HDL);
        default:
            break;
        }
    }
