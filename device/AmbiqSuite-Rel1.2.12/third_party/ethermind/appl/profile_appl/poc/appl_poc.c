 ...
 *  \file appl_poc.c
 *
 *  This is a stand-alone Pulse Oximeter Collector application.
 *
...
/** POC Characteristic related information */
typedef struct
{
    ...
    /* POS - Pulse Oximeter Service */

    /* Pulse Oximetry Feature */
    ATT_ATTR_HANDLE pos_po_feature_hdl;

    /* Pulse Oximetry Spot Check Measurement */
    ATT_ATTR_HANDLE pos_po_spot_chk_msrmt_hdl;

    /* Pulse Oximetry Spot Check Measurement - CCC */
    ATT_ATTR_HANDLE pos_po_spot_chk_msrmt_ccc_hdl;

    /* Pulse Oximetry Continuous Measurement */
    ATT_ATTR_HANDLE pos_po_continus_msrmt_hdl;

    /* Pulse Oximetry Continuous Measurement - CCC */
    ATT_ATTR_HANDLE pos_po_continus_msrmt_ccc_hdl;

    /* Pulse Oximeter RACP */
    ATT_ATTR_HANDLE pos_racp_hdl;

    /* Record Access Control Point - CCC */
    ATT_ATTR_HANDLE pos_racp_ccc_hdl;
    ...
    /* BMS Feature */
    ATT_ATTR_HANDLE bms_feature_hdl;

    /* Bond Management Control Point */
    ATT_ATTR_HANDLE bms_sc_cp_hdl;

    /* Bond Management Control Point - CCC */
    ATT_ATTR_HANDLE bms_sc_cp_ccc_hdl;
...
/* DIS - Device Information Service */
/* Manufacturer Name */
#define DIS_MANUFACTURER_NAME_HDL     (poc_char_info.dis_manufacturer_name_hdl)

/* Model Number */
#define DIS_MODEL_NUMBER_HDL          (poc_char_info.dis_model_number_hdl)

/* Serial Number */
#define DIS_SERIAL_NUMBER_HDL         (poc_char_info.dis_serial_number_hdl)

/* Hardware Revision */
#define DIS_HARDWARE_REVISION_HDL     (poc_char_info.dis_hardware_revision_hdl)

/* Firmware Revision */
#define DIS_FIRMWARE_REVISION_HDL     (poc_char_info.dis_firmware_revision_hdl)

/* Software Revision */
#define DIS_SOFTWARE_REVISION_HDL     (poc_char_info.dis_software_revision_hdl)

/* System Id */
#define DIS_SYSTEM_ID_HDL             (poc_char_info.dis_sys_id_hdl)

/* RegCertDataList */
#define DIS_REG_CERT_DATA_LIST_HDL    (poc_char_info.dis_reg_cert_data_list_hdl)
/* POS - Pulse Oximeter Service */

/* Pulse Oximetry Feature */
#define POS_PO_FEATURE_HDL              (poc_char_info.pos_po_feature_hdl)

/* Pulse Oximetry Spot Check Measurement */
#define POS_PO_SPOT_CHK_MSRMT_HDL       (poc_char_info.pos_po_spot_chk_msrmt_hdl)

/* Pulse Oximetry Spot Check Measurement - CCC */
#define POS_PO_SPOT_CHK_MSRMT_CCC_HDL   (poc_char_info.pos_po_spot_chk_msrmt_ccc_hdl)

/* Pulse Oximetry Continuous Measurement */
#define POS_PO_CONTINUS_MSRMT_HDL       (poc_char_info.pos_po_continus_msrmt_hdl)

/* Pulse Oximetry Continuous Measurement - CCC */
#define POS_PO_CONTINUS_MSRMT_CCC_HDL   (poc_char_info.pos_po_continus_msrmt_ccc_hdl)

/* Pulse Oximeter RACP */
#define POS_RACP_HDL                    (poc_char_info.pos_racp_hdl)

/* Pulse Oximeter RACP - CCC */
#define POS_RACP_CCC_HDL                (poc_char_info.pos_racp_ccc_hdl)

/* BAS - Battery Service */

/* Battery Level */
#define BAS_BATTERY_LEVEL_HDL           (poc_char_info.bas_batt_level_hdl)

/* Battery Level - CCC */
#define BAS_BATTERY_LEVEL_CCC_HDL       (poc_char_info.bas_batt_level_ccc_hdl)

/* BMS - Bond Management Service */

/* Bond Management Feature */
#define BMS_FEATURE_HDL                (poc_char_info.bms_feature_hdl)

/* Bond Management Control Point */
#define BMS_CP_HDL                     (poc_char_info.bms_sc_cp_hdl)

/* Bond Management Control Point - CCC */
#define BMS_CP_CCC_HDL                 (poc_char_info.bms_sc_cp_ccc_hdl)

/* CTS - Current Time Service */

/* Current Time */
#define CTS_CURRENT_TIME_HDL (poc_char_info.cts_current_time_hdl)

/* Current Time - CCC */
#define CTS_CURRENT_TIME_CCC_HDL (poc_char_info.cts_current_time_ccc_hdl)


#define APPL_CLI_CNFG_VAL_LENGTH    2

#define APPL_POC_INFO_INIT()\
        POS_PO_FEATURE_HDL = ATT_INVALID_ATTR_HANDLE_VAL;\
        POS_PO_SPOT_CHK_MSRMT_HDL = ATT_INVALID_ATTR_HANDLE_VAL;\
        POS_PO_SPOT_CHK_MSRMT_CCC_HDL = ATT_INVALID_ATTR_HANDLE_VAL;\
        POS_PO_CONTINUS_MSRMT_HDL  = ATT_INVALID_ATTR_HANDLE_VAL;\
        POS_PO_CONTINUS_MSRMT_CCC_HDL  = ATT_INVALID_ATTR_HANDLE_VAL;\
        POS_RACP_HDL  = ATT_INVALID_ATTR_HANDLE_VAL;\
        POS_RACP_CCC_HDL  = ATT_INVALID_ATTR_HANDLE_VAL;\
        ...
        DIS_REG_CERT_DATA_LIST_HDL = ATT_INVALID_ATTR_HANDLE_VAL;\
        BAS_BATTERY_LEVEL_HDL  = ATT_INVALID_ATTR_HANDLE_VAL;\
        BAS_BATTERY_LEVEL_CCC_HDL  = ATT_INVALID_ATTR_HANDLE_VAL;\
        BMS_FEATURE_HDL  = ATT_INVALID_ATTR_HANDLE_VAL;\
        BMS_CP_HDL  = ATT_INVALID_ATTR_HANDLE_VAL;\
        BMS_CP_CCC_HDL  = ATT_INVALID_ATTR_HANDLE_VAL;\
        CTS_CURRENT_TIME_HDL = ATT_INVALID_ATTR_HANDLE_VAL; \
        CTS_CURRENT_TIME_CCC_HDL = ATT_INVALID_ATTR_HANDLE_VAL;

#define REPORT_STORED_RECORDS_OPCODE                       1
#define DELETE_STORED_RECORDS_OPCODE                       2
#define ABORT_OPERATION_OPCODE                             3
#define REPORT_NUMBER_OF_RECORDS_OPCODE                    4

#define REPORT_STORED_RECORDS_OPERATOR                     1
#define DELETE_STORED_RECORDS_OPERATOR                     1
#define ABORT_OPERATION_OPERATOR                           0
#define REPORT_NUMBER_OF_RECORDS_OPERATOR                  1

/** Bond Management Service Macros */
/* BMS Opcodes */
#define APPL_BMS_DEL_BOND_REQ_DEV_BREDR_LE                 0x01
#define APPL_BMS_DEL_BOND_REQ_DEV_BREDR_ONLY               0x02
#define APPL_BMS_DEL_BOND_REQ_DEV_LE_ONLY                  0x03
#define APPL_BMS_DEL_ALL_BOND_BREDR_LE                     0x04
#define APPL_BMS_DEL_ALL_BOND_BREDR_ONLY                   0x05
#define APPL_BMS_DEL_ALL_BOND_LE_ONLY                      0x06
#define APPL_BMS_DEL_ALL_BUT_ACTIVE_BREDR_LE               0x07
#define APPL_BMS_DEL_ALL_BUT_ACTIVE_BREDR_ONLY             0x08
#define APPL_BMS_DEL_ALL_BUT_ACTIVE_LE_ONLY                0x09
/**
 * BMS Reserved Opcode is needed as "PLXP/COL/BMS/BI-05-I"
 * Testcase according to "PLXP.TS.1.0.1.pdf" expects
 * IUT to send a RFU Opcode to Tester inorder to test the
 * scenario where IUT is able to handle "Opcode Not Supported"
 * Error code.
 * A TSE with ID #9551 has been raised for this inconsistency.
 * TODO:
 * Need to monitor the status of the TSE #9551 and remove the
 * need of RFU Opcode once the TSE is accepted.
 */
#define APPL_BMS_RESERVED                                  0x0A

#define APPL_BMS_CP_REQ_LEN                                1
...
DECL_STATIC POC_CHAR_INFO poc_char_info;
...
static UCHAR poc_client_menu[] =
"\n\
    0 - Exit\n\
    1 - Refresh\n\n\
   --- Pulse Oximeter Service ---\n\
   10 - Discover Pulse Oximeter Service\n\n\
   11 - Read Pulse Oximetry Feature \n\n\
   12 - Configure Pulse Oximetry Spot Check Measurement for Indication\n\
   13 - Stop Pulse Oximetry Spot Check Measurement Indication\n\n\
   14 - Configure Pulse Oximetry Continuous Measurement for Notification\n\
   15 - Stop Pulse Oximetry Continuous Measurement Notification\n\n\
      -- RACP --\n\
   21 - Configure RACP CCC \n\
   22.- Stop RACP CCC \n\n\
      -- Remote Access Control Point -- \n\
   23.  Report Stored Records through Control Point \n\
   24.  Delete Stored Records through Control Point \n\
   25.  Abort Operation through Control Point \n\
   26.  Report Number of Stored Records through Control Point \n\n\
   --- Device Information Service ---\n\
   50 - Discover Device Information Service\n\
\n\
   51 - Read Manufacturer Name\n\
   52 - Read Model Number\n\
   53 - Read Serial Number\n\
   54 - Read Firmware Revision\n\
   55 - Read Hardware Revision\n\
   56 - Read Software Revision\n\
   57 - Read System ID\n\
   58 - Read Reg Cert Data List\n\n\
   --- Battery Service ---\n\
   60 - Discover Battery Service\n\
   61 - Read Battery Level\n\
   62 - Configure Battery Level for Notification\n\
   63 - Disable Battery Level Notification\n\n\
   --- BMS Service ---\n\
   70 - Discover BMS Service\n\
\n\
   71 - Read BMS Features\n\
   --- BMS control point procedures ----\n\
   72 - Delete bond of requesting device (BREDR & LE)\n\
   73 - Delete bond of requesting device (BREDR only)\n\
   74 - Delete bond of requesting device (LE only)\n\
   75 - Delete all bonds on server (BREDR & LE)\n\
   76 - Delete all bonds on server (BREDR only)\n\
   77 - Delete all bonds on server (LE only)\n\
   78 - Delete all but the active bond on server(BREDR & LE)\n\
   79 - Delete all but the active bond on server(BREDR only)\n\
   80 - Delete all but the active bond on server(LE only)\n\
   81 - Send Reserved Op Code\n\
\n\
    --- CTS Service ---\n\
   90 - Discover CTS Service\n\
   91 - Read Current Time \n\
   92 - Configure Current Time CCC \n\n\
\
Your Option?\n\
";
#else /* BT_SW_TXP */
...
API_RESULT appl_prepare_write_req
           (
               /* IN */ ATT_ATTR_HANDLE    handle
           )
{
    ...
    prepare_write_param.handle_value.handle = handle;
...
API_RESULT appl_execute_write_cmd
(
    /* IN */ ATT_ATTR_HANDLE     handle
)
{
    ...
    if(0 < length)
    {
        if(0x01 == type)
        {
            ...
            for(index = 0; index<length; index=index+4)
            {
                ...
                {
                    if (GATT_POX_SPOT_CHK_MSRMT_CHARACTERISTIC == \
                        APPL_CHAR_GET_UUID(APPL_GET_CURRENT_CHAR_INDEX()))
                    {
                        POS_PO_SPOT_CHK_MSRMT_CCC_HDL = handle;
                    }
                    else if (GATT_POX_CONTINUOUS_MSRMT_CHARACTERISTIC == \
                        APPL_CHAR_GET_UUID(APPL_GET_CURRENT_CHAR_INDEX()))
                    {
                        POS_PO_CONTINUS_MSRMT_CCC_HDL = handle;
                    }
                    else if (GATT_RACP_CHARACTERISTIC == \
                        APPL_CHAR_GET_UUID(APPL_GET_CURRENT_CHAR_INDEX()))
                    {
                        POS_RACP_CCC_HDL = handle;
                    }
                    else if (GATT_BATTERY_LEVEL_CHARACTERISTIC == \
                        APPL_CHAR_GET_UUID(APPL_GET_CURRENT_CHAR_INDEX()))
                    {
                        BAS_BATTERY_LEVEL_CCC_HDL = handle;
                    }
                    else if (GATT_BM_CNTRL_PNT_CHARACTERISTIC == \
                        APPL_CHAR_GET_UUID(APPL_GET_CURRENT_CHAR_INDEX()))
                    {
                        BMS_CP_CCC_HDL = handle;
                    }
                    else if (GATT_CURRENT_TIME_CHARACTERISTIC == \
                        APPL_CHAR_GET_UUID(APPL_GET_CURRENT_CHAR_INDEX()))
                    {
                        CTS_CURRENT_TIME_CCC_HDL = handle;
                    }
                }
            }
        }
     ...
     )
{
    ...
    for (index = 0; index < (unsigned)(data_len/(data_elem_size)); index++ )
    {
        ...
        if (APPL_GD_IN_CHAR_DSCVRY_STATE == APPL_GET_CURRENT_DSCVRY_STATE())
        {
            ...
            switch (uuid)
            {
            case GATT_POX_SPOT_CHK_MSRMT_CHARACTERISTIC:
                POS_PO_SPOT_CHK_MSRMT_HDL = value_handle;
                break;
            case GATT_POX_CONTINUOUS_MSRMT_CHARACTERISTIC:
                POS_PO_CONTINUS_MSRMT_HDL = value_handle;
                break;
            case GATT_POX_FEATURES_CHARACTERISTIC:
                POS_PO_FEATURE_HDL = value_handle;
                break;
            case GATT_RACP_CHARACTERISTIC:
                POS_RACP_HDL = value_handle;
                break;
            ...
            case GATT_BATTERY_LEVEL_CHARACTERISTIC:
                ...
                break;
            case GATT_BM_FEATURES_CHARACTERISTIC:
                BMS_FEATURE_HDL = value_handle;
                break;
            case GATT_BM_CNTRL_PNT_CHARACTERISTIC:
                BMS_CP_HDL = value_handle;
                break;
            case GATT_CURRENT_TIME_CHARACTERISTIC:
                CTS_CURRENT_TIME_HDL = value_handle;
                break;
...
*  \return   : None.
*/
void appl_discover_current_time_service(void)
{
    ATT_UUID16             uuid16;

    uuid16 = GATT_CURRENT_TIME_SERVICE;
 ...
 *  \return   : None.
 */
void appl_discover_pulse_oximeter_service(void)
{
    ATT_UUID16             uuid16;

    uuid16 = GATT_PULSE_OXIMETER_SERVICE;

    /* Discover Pulse Oximeter Service */
    appl_discover_service
    (
        &uuid16,
        ATT_16_BIT_UUID_FORMAT
...
/**
 *  Function to initiate Service Discovery for Bond Management.
 *
 *  \param None.
 *
 *  \return   : None.
 */
void appl_discover_bond_management_service(void)
{
    ATT_UUID16             uuid16;

    uuid16 = GATT_BM_SERVICE;
...
API_RESULT appl_bmc_cp_handler
            (
                /* IN */ UCHAR opcode
            )
{
    ...
    value_arr[0] = opcode;
    CONSOLE_OUT ("1.Write Response\n2.Prepare Write\n3.Execute Write\n");
    CONSOLE_IN ("%u", &choice);

    if (1 == choice)
    {
        CONSOLE_OUT ("Enter the length of Authorization code to be sent (0 if no authorization code):\n");
        CONSOLE_IN ("%u", &input);
        length = (UINT16) input;
        if (0 != length)
        {
            CONSOLE_OUT ("Enter %u length Authorization code\n", length);
        }
        index = 0;
        while(index < length)
        {
            CONSOLE_IN("%u", &auth_code[index]);
            index++;
        }
        value.len = length + 1;
        data_length = length;
        ...
        {
            length--;
            value_arr[index] = (UCHAR) auth_code[index - 1];
            index++;
        }
        if (0 != value.len)
        {
            att_value.len = data_length + 1;
            att_value.val = value_arr;
            appl_write_req (BMS_CP_HDL,&att_value);
        }
    }
    else if(2 == choice)
    {
        appl_prepare_write_req((UINT16) BMS_CP_HDL);
    }
    else if(3 == choice)
    {
        appl_execute_write_cmd((UINT16) BMS_CP_HDL);
    }
    else
    {
...
void appl_profile_operations (void)
{
    ...
    while (1)
    {
        ...
        case 1:
            break;
        case 10:
            appl_discover_pulse_oximeter_service();
            break;
        case 11:
            appl_read_req(POS_PO_FEATURE_HDL);
            break;
        case 12:
            ...
            value.val = cfg_val;
            appl_write_req (POS_PO_SPOT_CHK_MSRMT_CCC_HDL,&value);
            break;
        case 13:
        ...
        case 14:
            ...
            value.len = APPL_CLI_CNFG_VAL_LENGTH;
            value.val = cfg_val;
            appl_write_req (POS_PO_CONTINUS_MSRMT_CCC_HDL,&value);
            break;
        case 15:
            cli_cfg = GATT_CLI_CNFG_DEFAULT;
            BT_PACK_LE_2_BYTE(cfg_val, &cli_cfg);
        ...
        case 21:
            ...
            value.len = APPL_CLI_CNFG_VAL_LENGTH;
            value.val = cfg_val;
            appl_write_req(POS_RACP_CCC_HDL, &value);
            break;
        case 22:
            cli_cfg = GATT_CLI_CNFG_DEFAULT;
            BT_PACK_LE_2_BYTE(cfg_val, &cli_cfg);
            ...
            break;
        case 23:
            value_arr[0] = REPORT_STORED_RECORDS_OPCODE;
            value_arr[1] = REPORT_STORED_RECORDS_OPERATOR;
            value.val = value_arr;
            value.len = 2;
            appl_write_req(POS_RACP_HDL, &value);
            break;
        case 24:
            value_arr[0] = DELETE_STORED_RECORDS_OPCODE;
            value_arr[1] = DELETE_STORED_RECORDS_OPERATOR;
            value.val = value_arr;
            value.len = 2;
            appl_write_req(POS_RACP_HDL, &value);
            break;
        case 25:
            value_arr[0] = ABORT_OPERATION_OPCODE;
            value_arr[1] = ABORT_OPERATION_OPERATOR;
            value.val = value_arr;
            value.len = 2;
            appl_write_req(POS_RACP_HDL, &value);
            break;
        case 26:
            value_arr[0] = REPORT_NUMBER_OF_RECORDS_OPCODE;
            value_arr[1] = REPORT_NUMBER_OF_RECORDS_OPERATOR;
            value.val = value_arr;
            value.len = 2;
            appl_write_req(POS_RACP_HDL, &value);
            break;
        case 50:
            ...
            break;
        case 51:
            appl_read_req(DIS_MANUFACTURER_NAME_HDL);
            break;
        case 52:
            appl_read_req(DIS_MODEL_NUMBER_HDL);
            break;
        case 53:
            appl_read_req(DIS_SERIAL_NUMBER_HDL);
            break;
        case 54:
            appl_read_req(DIS_FIRMWARE_REVISION_HDL);
            break;
        case 55:
            appl_read_req(DIS_HARDWARE_REVISION_HDL);
            break;
        case 56:
            appl_read_req(DIS_SOFTWARE_REVISION_HDL);
            break;
        case 57:
            appl_read_req(DIS_SYSTEM_ID_HDL);
            break;
        case 58:
            appl_read_req(DIS_REG_CERT_DATA_LIST_HDL);
            break;
        ...
        case 62:
            ...
            value.len = APPL_CLI_CNFG_VAL_LENGTH;
            value.val = cfg_val;
            appl_write_req (BAS_BATTERY_LEVEL_CCC_HDL,&value);
            break;
        case 63:
            cli_cfg = GATT_CLI_CNFG_DEFAULT;
            BT_PACK_LE_2_BYTE(cfg_val, &cli_cfg);
            ...
            break;
        case 70:
            appl_discover_bond_management_service ();
            break;
        case 71:
            appl_read_req (BMS_FEATURE_HDL);
            break;
        case 72:
            appl_bmc_cp_handler (APPL_BMS_DEL_BOND_REQ_DEV_BREDR_LE);
            break;
        case 73:
            appl_bmc_cp_handler (APPL_BMS_DEL_BOND_REQ_DEV_BREDR_ONLY);
            break;
        case 74:
            appl_bmc_cp_handler (APPL_BMS_DEL_BOND_REQ_DEV_LE_ONLY);
            break;
        case 75:
            appl_bmc_cp_handler (APPL_BMS_DEL_ALL_BOND_BREDR_LE);
            break;
        case 76:
            appl_bmc_cp_handler (APPL_BMS_DEL_ALL_BOND_BREDR_ONLY);
            break;
        case 77:
            appl_bmc_cp_handler (APPL_BMS_DEL_ALL_BOND_LE_ONLY);
            break;
        case 78:
            appl_bmc_cp_handler (APPL_BMS_DEL_ALL_BUT_ACTIVE_BREDR_LE);
            break;
        case 79:
            appl_bmc_cp_handler (APPL_BMS_DEL_ALL_BUT_ACTIVE_BREDR_ONLY);
            break;
        case 80:
            appl_bmc_cp_handler (APPL_BMS_DEL_ALL_BUT_ACTIVE_LE_ONLY);
            break;
        case 81:
            /**
             * BMS Reserved Opcode is needed as "PLXP/COL/BMS/BI-05-I"
             ...
             * need of RFU Opcode once the TSE is accepted.
             */
            appl_bmc_cp_handler (APPL_BMS_RESERVED);
            break;
        case 90:
            appl_discover_current_time_service();
            break;
        case 91:
            appl_read_req(CTS_CURRENT_TIME_HDL);
            break;
        case 92:
            cli_cfg = GATT_CLI_CNFG_NOTIFICATION;
            BT_PACK_LE_2_BYTE(cfg_val, &cli_cfg);
            value.len = APPL_CLI_CNFG_VAL_LENGTH;
            value.val = cfg_val;
            appl_write_req(CTS_CURRENT_TIME_CCC_HDL, &value);
            break;
        default:
            break;
        }
