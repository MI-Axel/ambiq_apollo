 ...
 *  \file appl_vse7.h
 *
 *  Application Header File for VSE7.
 */
...
#ifndef _H_APPL_VSE7_
#define _H_APPL_VSE7_
...
#include "gatt_db.h"
#include "appl.h"
#include "appl_vse7_att_server.h"
...
void appl_vse7_connect(DEVICE_HANDLE  * dq_handle);
...
/* Profile handling */
#define APPL_PROFILE_INIT(...) appl_vse7_init()
#define APPL_PROFILE_CONNECT(x) appl_vse7_connect(x)
#define APPL_SEND_MEASUREMENT(x)appl_send_heart_rate_measurement(x)
#define APPL_PROFILE_DISCONNECT_HANDLER(x) appl_vse7_server_reinitialize()
#define GATT_DB_PROFILE_HANDLER  gatt_db_vse7_handler
