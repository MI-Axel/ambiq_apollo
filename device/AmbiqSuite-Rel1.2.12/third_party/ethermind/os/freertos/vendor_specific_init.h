...
#define VS_INIT_TRC(...)    BT_debug_trace(bt_debug_fd, __VA_ARGS__)
#define VS_INIT_INF(...)    BT_debug_info(bt_debug_fd, __VA_ARGS__)
#define VS_INIT_ERR(...)    BT_debug_error(bt_debug_fd, __VA_ARGS__)
