...
#define HCI_UART_ERR(...)               BT_debug_error(BT_MODULE_ID_TRANSPORT, __VA_ARGS__)
#define HCI_UART_TRC(...)               BT_debug_trace(BT_MODULE_ID_TRANSPORT, __VA_ARGS__)
#define HCI_UART_INF(...)               BT_debug_info(BT_MODULE_ID_TRANSPORT, __VA_ARGS__)

#define HCI_UART_debug_dump_bytes(data, datalen) BT_debug_dump_bytes(BT_MODULE_ID_TRANSPORT, (data), (datalen))
...
#define HCI_UART_debug_dump_bytes(data, datalen)
