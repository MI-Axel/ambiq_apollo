 ...
 *  --------+--------------------+------------------+---------------------
 *  0x0016  |       0x2803       | Rd               | 0x02, 0x0017, 0x2A07
 *  --------+--------------------+------------------+---------------------
 *  0x0017  |       0x2A07       | Rd               | 0.0
 */
...
DECL_CONST UCHAR gatt_const_value_arr[GATT_CONST_VALUE_ARRAY_SIZE] =
{
    ...
    0x0A, 0x11, 0x00, 0x06, 0x2A,

    /* 49 - AlertLevel(5); Property: 0x04, Value Handle: 0x0014, UUID: 0x2A06 */
    0x04, 0x14, 0x00, 0x06, 0x2A,

    /* 54 - TxPower(6); Property: 0x02, Value Handle: 0x0017, UUID: 0x2A07 */
    0x02, 0x17, 0x00, 0x07, 0x2A,
};
