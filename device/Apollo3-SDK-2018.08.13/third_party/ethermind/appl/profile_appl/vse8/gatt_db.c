 ...
 *  ========+====================+==================+=====================
 *  0x000F  |       0x2800       | Rd               | 0xA0A1A2A3A4A5A6A7
 *          |                    |                  |   A8A9AAABACADAEAF
 *  --------+--------------------+------------------+---------------------
 *  0x0010  |       0x2803       | Rd               | 0x10, 0x0011,
 *          |                    |                  | 0xB0B1B2B3B4B5B6B7
 *          |                    |                  |   B8B9BABBBCBDBEBF
 *  --------+--------------------+------------------+---------------------
 *  0x0011  | 0xB0B1B2B3B4B5B6B7 | Ntf              | N/A
 *          |   B8B9BABBBCBDBEBF |                  |
 *  --------+--------------------+------------------+---------------------
...
#if ((defined VSE8) && (defined GATT_DB))
...
DECL_CONST UCHAR gatt_const_uuid_arr[GATT_UUID_ARRAY_SIZE] =
{
    ...
    /* 34 - Vendor Specific - Tx Service UUID */
    0xAF, 0xAE, 0xAD, 0xAC, 0xAB, 0xAA, 0xA9, 0xA8,
    0xA7, 0xA6, 0xA5, 0xA4, 0xA3, 0xA2, 0xA1, 0xA0,

    /* 50 - Vendor Specific - Tx Data Port Characteristic UUID */
...
{
    /* 0 - Service Changed(2); Default: N/A */
    0x00, 0x00, 0x00, 0x00,

    /* 4 - BatteryLevel(3); Default: 100.0 */
    0x64,
};
...
DECL_CONST UCHAR gatt_const_value_arr[GATT_CONST_VALUE_ARRAY_SIZE] =
{
    ...
    /**
     *  42 - Vendor Specific - Tx Data Port(4);
     *  Property: 0x10,
     *  Value Handle: 0x0011,
     *  UUID: 0xB0B1B2B3B4B5B6B7B8B9BABBBCBDBEBF
     */
    0x10, 0x11, 0x00, 0xBF, 0xBE, 0xBD, 0xBC, 0xBB, 0xBA, 0xB9, 0xB8,
    0xB7, 0xB6, 0xB5, 0xB4, 0xB3, 0xB2, 0xB1, 0xB0,
};
...
DECL_CONST UCHAR gatt_db_const_peer_specific_val_arr[GATT_DB_PEER_VALUE_ARRAY_SIZE] =
{
    ...
    /* 4 - Client Configuration for Vendor Specific - Tx Data Port */
    /* Client Instance 0 */
    0x00, 0x00,
};
...
DECL_CONST GATT_DB_DESC_DATA gatt_db_attr_table[GATT_DB_MAX_ATTRIBUTES] =
{
    ...
    /* Handle - 0x000F */
    /* 3 - Vendor Specific - Tx - Service Declaration */
    {
        /* Property */
        GATT_DB_READ,
    ...
    /* Handle - 0x0010 */
    /* 4 - Vendor Specific - Tx Data Port - Characteristic Declaration */
    {
        /* Property */
        GATT_DB_READ,
    ...
    /* Handle - 0x0011 */
    /* 4 - Vendor Specific - Tx Data Port - Characteristic Value */
    {
        /* Property */
        GATT_DB_CHAR_NOTIFY_PROPERTY,
    ...
    /* Handle - 0x0012 */
    /* 4 - Vendor Specific - Tx Data Port - CCD */
    {
        /* Property */
        GATT_DB_READ |
        GATT_DB_WRITE,
...
DECL_CONST GATT_DB_CHARACERISTIC gatt_characteristic[GATT_CHARACTERISTIC_COUNT] =
{
    ...
    /* 4 - Vendor Specific - Tx Data Port */
    {
        {
            /* Number of attributes in characteristic including the definition */
            3,
...
DECL_CONST GATT_DB_SERVICE gatt_service[GATT_SERVICE_COUNT] =
{
    ...
    /* 3 - Vendor Specific - Tx */
    {
        ...
        /* Service Description */
        GATT_DB_SER_NO_SECURITY_PROPERTY |
        GATT_DB_SER_128_BIT_UUID_FORMAT |
        GATT_DB_SER_SUPPORT_ANY_LINK_TYPE,
...
#endif /* ((defined VSE8) && (defined GATT_DB)) */
