...
/** CPMC Characteristic related information */
typedef struct
{
    ...
    /* CPM - Cycling Power Meter Service */

    /* CPM Measurment */
    ATT_ATTR_HANDLE cpms_cpm_msrmnt_hdl;

    /* CPM Measurment CCD */
    ATT_ATTR_HANDLE cpms_cpm_msrmnt_ccd_hdl;

    /* CPM Measurment SCD */
    ATT_ATTR_HANDLE cpms_cpm_msrmnt_scd_hdl;

    /* CPM Measurment */
    ATT_ATTR_HANDLE cpms_cpm_vectr_hdl;

    /* CPM Measurment CCD */
    ATT_ATTR_HANDLE cpms_cpm_vectr_ccd_hdl;

    /* CPM Feature */
    ATT_ATTR_HANDLE cpms_cpm_feature_hdl;

    /* Sensor Location */
    ATT_ATTR_HANDLE cpms_cpm_snsr_loc_hdl;

    /* CPM Control Point */
    ATT_ATTR_HANDLE cpms_cpm_cp_hdl;

    /* CPM Control Point CCD */
    ATT_ATTR_HANDLE cpms_cpm_cp_ccd_hdl;
...
/* Manufacturer Name */
#define DIS_MANUFACTURER_NAME_HDL     (cpmc_char_info.dis_manufacturer_name_hdl)

/* Model Number */
#define DIS_MODEL_NUMBER_HDL          (cpmc_char_info.dis_model_number_hdl)

/* Serial Number */
#define DIS_SERIAL_NUMBER_HDL         (cpmc_char_info.dis_serial_number_hdl)

/* Hardware Revision */
#define DIS_HARDWARE_REVISION_HDL     (cpmc_char_info.dis_hardware_revision_hdl)

/* Firmware Revision */
#define DIS_FIRMWARE_REVISION_HDL     (cpmc_char_info.dis_firmware_revision_hdl)

/* Software Revision */
#define DIS_SOFTWARE_REVISION_HDL     (cpmc_char_info.dis_software_revision_hdl)

/* System Id */
#define DIS_SYSTEM_ID_HDL             (cpmc_char_info.dis_sys_id_hdl)

/* RegCertDataList */
#define DIS_REG_CERT_DATA_LIST_HDL    (cpmc_char_info.dis_reg_cert_data_list_hdl)

#define CPMS_CPM_MSRMNT_HDL           (cpmc_char_info.cpms_cpm_msrmnt_hdl)

#define CPMS_CPM_MSRMNT_CCD_HDL       (cpmc_char_info.cpms_cpm_msrmnt_ccd_hdl)

#define CPMS_CPM_MSRMNT_SCD_HDL       (cpmc_char_info.cpms_cpm_msrmnt_scd_hdl)

#define CPMS_CPM_VECTR_HDL            (cpmc_char_info.cpms_cpm_vectr_hdl)

#define CPMS_CPM_VECTR_CCD_HDL        (cpmc_char_info.cpms_cpm_vectr_ccd_hdl)

#define CPMS_CPM_FEATURE_HDL          (cpmc_char_info.cpms_cpm_feature_hdl)

#define CPMS_CPM_SENSR_LOC_HDL        (cpmc_char_info.cpms_cpm_snsr_loc_hdl)

#define CPMS_CPM_CP_HDL               (cpmc_char_info.cpms_cpm_cp_hdl)

#define CPMS_CPM_CP_CCD_HDL           (cpmc_char_info.cpms_cpm_cp_ccd_hdl)

/* BAS - Battery Service */

/* Battery Level */
#define BAS_BATTERY_LEVEL_HDL          (cpmc_char_info.bas_batt_level_hdl)

#define APPL_SER_CFG_VAL_LENNGTH    2
#define APPL_CLI_CNFG_VAL_LENGTH    2

#define APPL_CPMC_INFO_INIT()\
        ...
        CPMS_CPM_MSRMNT_HDL = ATT_INVALID_ATTR_HANDLE_VAL;\
        CPMS_CPM_MSRMNT_CCD_HDL = ATT_INVALID_ATTR_HANDLE_VAL;\
        CPMS_CPM_VECTR_HDL = ATT_INVALID_ATTR_HANDLE_VAL;\
        CPMS_CPM_VECTR_CCD_HDL = ATT_INVALID_ATTR_HANDLE_VAL;\
        CPMS_CPM_FEATURE_HDL = ATT_INVALID_ATTR_HANDLE_VAL;\
        CPMS_CPM_SENSR_LOC_HDL = ATT_INVALID_ATTR_HANDLE_VAL;\
        CPMS_CPM_CP_HDL = ATT_INVALID_ATTR_HANDLE_VAL;\
        CPMS_CPM_CP_CCD_HDL = ATT_INVALID_ATTR_HANDLE_VAL;

/** CPM Control Point Commands */
#define SET_CUMMULATIVE_VALUE_OPCODE             1
#define UPDATE_SENSOR_LOCATION_OPCODE            2
#define REQUEST_SUPPORTED_SENSOR_LOCATION_OPCODE 3
#define SET_CRANK_LENGTH_OPCODE                  4
#define REQUEST_CRANK_LENGTH_OPCODE              5
#define SET_CHAIN_LENGTH_OPCODE                  6
#define REQUEST_CHAIN_LENGTH_OPCODE              7
#define SET_CHAIN_WEIGHT_OPCODE                  8
#define REQUEST_CHAIN_WEIGHT_OPCODE              9
#define SET_SPAN_LENGTH_OPCODE                   10
#define REQUEST_SPAN_LENGTH_OPCODE               11
#define START_OFFSET_COMPENSATION_OPCODE         12
#define MASK_CPM_CHAR_CONTENT_OPCODE             13
#define REQ_SAMPLING_RATE                        14
#define REQ_FACTORY_CALIBRATION_DATE             15
#define START_ENHND_OFFSET_COMPSN_OPCODE         16
...
DECL_STATIC CPMC_CHAR_INFO cpmc_char_info; ;
...
======== M A I N   M E N U ======== \r\n\
 ...
 \r\n\
   41.  Profile Menu \r\n\
 \r\n\
   50.  Get HCI Connection Details \r\n\
   51.  Disconnect \r\n\
 \r\n\
   Your Option ? \0";

static UCHAR cpmc_client_menu[] =
"\n\
    0 - Exit\n\
    1 - Refresh\n\
...
\n\
   ...
   12 - Configure CPM Measurment for Notification\n\
   13 - Disable CPM Measurment Notification\n\
   14 - Configure Server Configuration for Broadcast\n\
   15 - Disable Server COnfiguration\n\
   16 - Read CPM Feature\n\
   17 - Read CPM Sensor Location\n\
   18 - Read CP Vector CCD\n\
   19 - Configure CP Vector for Notification\n\
   20 - Disable CP Vector Notification\n\
   --- Control Point Operations ---\n\
   21 - Read CPM Control Point CCD\n\
   22 - Configure CPM Control Point for Indication\n\
   23 - Disable CPM Control Point Indication\n\
   24 - Set Cummulative Value\n\
   25 - Update Sensor Location\n\
   26 - Request Supported Sensor Locations\n\
   27 - Set Crank Length\n\
   28 - Request Crank Length\n\
   29 - Set Chain Length\n\
   30 - Request Chain Length\n\
   31 - Set Chain Weight\n\
   32 - Request Chain Weight\n\
   33 - Set Span Length\n\
   34 - Request Span Length\n\
   35 - Start Offset Compensation\n\
   36 - Mask Cycling Power Measurement\n\
   37 - Request Sampling Rate\n\
   38 - Request Factory Calibration Date\n\
   39 - Configure CPM for Broadcast\n\
   40 - Start Enhanced Offset Compensation \n\n\
    ...
    if(0 < length)
    {
        if(0x01 == type)
        {
            ...
            for(index = 0; index<length; index=index+4)
            {
                ...
                {
                    if (GATT_CPM_MSRMT_CHARACTERISTIC == \
                        APPL_CHAR_GET_UUID(APPL_GET_CURRENT_CHAR_INDEX()))
                    {
                        CPMS_CPM_MSRMNT_CCD_HDL = handle;
                    }
                    else if (GATT_CPM_VECTOR_CHARACTERISTIC == \
                        APPL_CHAR_GET_UUID(APPL_GET_CURRENT_CHAR_INDEX()))
                    {
                        CPMS_CPM_VECTR_CCD_HDL = handle;
                    }
                    else if (GATT_CPM_CNTRL_PNT_CHARACTERISTIC == \
                        APPL_CHAR_GET_UUID(APPL_GET_CURRENT_CHAR_INDEX()))
                    {
                        CPMS_CPM_CP_CCD_HDL = handle;
                    }
                }
                else if (GATT_SERVER_CONFIG == uuid)
                {
                    CPMS_CPM_MSRMNT_SCD_HDL = handle;
                }
            }
        }
        else if(0x02 == type)
    ...
    for (index = 0; index < (unsigned)(data_len/(data_elem_size)); index++ )
    {
        ...
        if (APPL_GD_IN_CHAR_DSCVRY_STATE == APPL_GET_CURRENT_DSCVRY_STATE())
        {
            ...
            case GATT_CPM_MSRMT_CHARACTERISTIC:
                CPMS_CPM_MSRMNT_HDL = value_handle;
                break;

            case GATT_CPM_VECTOR_CHARACTERISTIC:
                CPMS_CPM_VECTR_HDL = value_handle;
                break;

            case GATT_CPM_FEATURE_CHARACTERISTIC:
                CPMS_CPM_FEATURE_HDL = value_handle;
                break;

            case GATT_SENSOR_LOCATION_CHARACTERISTIC:
                CPMS_CPM_SENSR_LOC_HDL = value_handle;
                break;

            case GATT_CPM_CNTRL_PNT_CHARACTERISTIC:
                CPMS_CPM_CP_HDL = value_handle;
                break;
...
/**
 *  Function to initiate Service Discovery for CPM service.
 *
 *  \param None.
 *
 *  \return   : None.
 */
void appl_discover_cpm_service(void)
{
    ATT_UUID16             uuid16;

    uuid16 = GATT_CPM_SERVICE;

    /* Discovery CPM Service */
    appl_discover_service
    (
        &uuid16,
        ATT_16_BIT_UUID_FORMAT
...
void appl_hci_get_connection_details ( void )
{
    ...
    APPL_TRC("Getting Connection Details from HCI ...\n"); fflush(stdout);
    ...
    else
    {
        ...
        {
            APPL_TRC("Connection Detail %d:\n", i);
            APPL_TRC("  BD_ADDR = %02X:%02X:%02X:%02X:%02X:%02X. Type 0x%02X\n",
...
void appl_profile_operations (void)
{
    ...
    while (1)
    {
        ...
        case 1:
            break;
        case 2:
            CONSOLE_OUT ("Enter Device ID: ");
            CONSOLE_IN ("%x", &choice);
            appl_gatt_client_handle.device_id = choice;
            CONSOLE_OUT ("Enter ATT ID: ");
            CONSOLE_IN ("%x", &choice);
            appl_gatt_client_handle.att_id = choice;
            break;
        case 10:
            appl_discover_cpm_service();
            break;
        case 11:
            appl_read_req(CPMS_CPM_MSRMNT_CCD_HDL);
            break;
        case 12:
            ...
            value.val = cfg_val;
            appl_write_req (CPMS_CPM_MSRMNT_CCD_HDL,&value);
            break;
        case 13:
        ...
        case 14:
            ...
            value.len = APPL_CLI_CNFG_VAL_LENGTH;
            value.val = cfg_val;
            appl_write_req (CPMS_CPM_MSRMNT_SCD_HDL,&value);
            break;
        case 15:
            ...
            break;
        case 16:
            appl_read_req(CPMS_CPM_FEATURE_HDL);
            break;
        case 17:
            appl_read_req(CPMS_CPM_SENSR_LOC_HDL);
            break;
        case 18:
            appl_read_req(CPMS_CPM_VECTR_CCD_HDL);
            break;
        case 19:
            cli_cfg = GATT_CLI_CNFG_NOTIFICATION;
            BT_PACK_LE_2_BYTE(cfg_val, &cli_cfg);
            value.len = APPL_CLI_CNFG_VAL_LENGTH;
            value.val = cfg_val;
            appl_write_req (CPMS_CPM_VECTR_CCD_HDL,&value);
            break;
        case 20:
            cli_cfg = GATT_CLI_CNFG_DEFAULT;
            BT_PACK_LE_2_BYTE(cfg_val, &cli_cfg);
            ...
            break;
        case 21:
            appl_read_req(CPMS_CPM_CP_CCD_HDL);
            break;
        case 22:
            ...
            value.len = APPL_CLI_CNFG_VAL_LENGTH;
            value.val = cfg_val;
            appl_write_req (CPMS_CPM_CP_CCD_HDL,&value);
            break;
        case 23:
            cli_cfg = GATT_CLI_CNFG_DEFAULT;
            BT_PACK_LE_2_BYTE(cfg_val, &cli_cfg);
            ...
            break;
        case 24:
            value.val = &value_arr[0];
            value_arr[0] = SET_CUMMULATIVE_VALUE_OPCODE;
            CONSOLE_OUT("Enter the 4 Octet Cummulative Value to be set[Hex]:\n");
            while (index < 5)
            {
                CONSOLE_IN("%x", &data);
            ...
            if (0 != value.len)
            {
                appl_write_req (CPMS_CPM_CP_HDL,&value);
                index = 1;
            }
            break;
        case 25:
            value.val = &value_arr[0];
            value_arr[0] = UPDATE_SENSOR_LOCATION_OPCODE;
            CONSOLE_OUT("Enter the Sensor Location to be set[Hex]:\n");
            CONSOLE_IN("%x", &data);
            value_arr[1] = (UCHAR) data;
            value.len = 2;
            if (0 != value.len)
            {
               appl_write_req (CPMS_CPM_CP_HDL,&value);
        ...
        case 26:
            value.val = &value_arr[0];
            value_arr[0] = REQUEST_SUPPORTED_SENSOR_LOCATION_OPCODE;
            value.len = 1;
            if (0 != value.len)
            {
               appl_write_req (CPMS_CPM_CP_HDL,&value);
        ...
        case 27:
            value.val = &value_arr[0];
            value_arr[0] = SET_CRANK_LENGTH_OPCODE;
            CONSOLE_OUT("Enter the Crank Length to be set[Hex]:\n");
            CONSOLE_IN("%x", &data);
            BT_PACK_LE_2_BYTE((value_arr + 1),&data);
            value.len = 3;
            if (0 != value.len)
            {
               appl_write_req (CPMS_CPM_CP_HDL,&value);
        ...
        case 28:
            value.val = &value_arr[0];
            value_arr[0] = REQUEST_CRANK_LENGTH_OPCODE;
            value.len = 1;
            if (0 != value.len)
            {
               appl_write_req (CPMS_CPM_CP_HDL,&value);
        ...
        case 29:
            value.val = &value_arr[0];
            value_arr[0] = SET_CHAIN_LENGTH_OPCODE;
        ...
        case 30:
            value.val = &value_arr[0];
            value_arr[0] = REQUEST_CHAIN_LENGTH_OPCODE;
            value.len = 1;
            if (0 != value.len)
            {
               appl_write_req (CPMS_CPM_CP_HDL,&value);
        ...
        case 31:
            value.val = &value_arr[0];
            value_arr[0] = SET_CHAIN_WEIGHT_OPCODE;
        ...
        case 32:
            value.val = &value_arr[0];
            value_arr[0] = REQUEST_CHAIN_WEIGHT_OPCODE;
            value.len = 1;
            if (0 != value.len)
            {
               appl_write_req (CPMS_CPM_CP_HDL,&value);
        ...
        case 33:
            value.val = &value_arr[0];
            value_arr[0] = SET_SPAN_LENGTH_OPCODE;
        ...
        case 34:
            value.val = &value_arr[0];
            value_arr[0] = REQUEST_SPAN_LENGTH_OPCODE;
            value.len = 1;
            if (0 != value.len)
            {
               appl_write_req (CPMS_CPM_CP_HDL,&value);
        ...
        case 35:
            value.val = &value_arr[0];
            value_arr[0] = START_OFFSET_COMPENSATION_OPCODE;
            value.len = 1;
            if (0 != value.len)
            {
               appl_write_req (CPMS_CPM_CP_HDL,&value);
        ...
        case 36:
            value.val = &value_arr[0];
            value_arr[0] = MASK_CPM_CHAR_CONTENT_OPCODE;
        ...
        case 38:
            value.val = &value_arr[0];
            value_arr[0] = REQ_FACTORY_CALIBRATION_DATE;
            value.len = 1;
            if (0 != value.len)
            {
               appl_write_req (CPMS_CPM_CP_HDL,&value);
        ...
        case 39:
            cli_cfg = GATT_SER_CNFG_BROADCAST;
            BT_PACK_LE_2_BYTE(cfg_val, &cli_cfg);
            value.len = APPL_SER_CFG_VAL_LENNGTH;
            value.val = cfg_val;
            appl_write_req(CPMS_CPM_MSRMNT_SCD_HDL, &value);
            break;
        case 40:
            value.val = &value_arr[0];
            value_arr[0] = START_ENHND_OFFSET_COMPSN_OPCODE;
            value.len = 1;
            if (0 != value.len)
            {
                appl_write_req(CPMS_CPM_CP_HDL, &value);
...
void appl_master_menu_handler(void)
{
    ...
    case 51:
        {
            /* Initiate BLE Disconnection - Step 2(f) */
            CONSOLE_OUT("Connection Handle (in Hex) = "); fflush(stdout);
            CONSOLE_IN("%x", &read);
            appl_ble_connection_handle = (UINT16)read;
            BT_hci_disconnect (appl_ble_connection_handle, 0x13);
        }
        break;
