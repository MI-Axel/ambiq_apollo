 ...
 *  ========+====================+==================+=====================
 *  0x000F  |       0x2800       | Rd               | 0x1802
 *  --------+--------------------+------------------+---------------------
 *  0x0010  |       0x2803       | Rd               | 0x04, 0x0011, 0x2A06
 *  --------+--------------------+------------------+---------------------
 *  0x0011  |       0x2A06       | Wwr              | 0.0
 */
...
#if ((defined FMT) && (defined GATT_DB))
...
DECL_CONST UCHAR gatt_const_uuid_arr[GATT_UUID_ARRAY_SIZE] =
{
    ...
    /* 34 - Immediate Alert Service UUID */
    0x02, 0x18,
...
DECL_CONST UCHAR gatt_const_value_arr[GATT_CONST_VALUE_ARRAY_SIZE] =
{
    ...
    0x4D, 0x69, 0x6E, 0x64, 0x74, 0x72, 0x65, 0x65, 0x50, 0x72, 0x6F, 0x78,
    0x69, 0x6D, 0x6F,
    ...
    /* 44 - AlertLevel(4); Property: 0x04, Value Handle: 0x0011, UUID: 0x2A06 */
    0x04, 0x11, 0x00, 0x06, 0x2A,
};
...
DECL_CONST GATT_DB_DESC_DATA gatt_db_attr_table[GATT_DB_MAX_ATTRIBUTES] =
{
    ...
    /* Handle - 0x000F */
    /* 3 - Immediate Alert - Service Declaration */
    {
        /* Property */
        GATT_DB_READ,
...
#endif /* ((defined FMT) && (defined GATT_DB)) */
