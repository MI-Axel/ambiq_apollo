...
typedef struct
{
    ...
    arm_rfft_fast_instance_f32* p_armfft;
}am_app_stft_instance_f32;


extern void stft_init_f32(am_app_stft_instance_f32* Sf, arm_rfft_fast_instance_f32* p_armfft, uint16_t fft_len, uint16_t hop, uint16_t roll_frames, const float* window_buff);
