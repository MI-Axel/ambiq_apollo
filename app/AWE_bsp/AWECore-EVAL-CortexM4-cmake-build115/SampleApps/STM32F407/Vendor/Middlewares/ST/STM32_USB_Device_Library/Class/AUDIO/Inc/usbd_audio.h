...
/** @defgroup USBD_AUDIO_Exported_Defines
  * @{
  */
#define AUDIO_OUT_EP 0x01 // Audio Data out endpoint
#define AUDIO_IN_EP  0x82 // Audio Data in endpoint
...
#define USB_AUDIO_CONFIG_DESC_SIZ                     141
...
#define IN_VOL_MIN                                    0xDBE0
#define IN_VOL_RES                                    0x0023
#define OUT_VOL_MIN                                   0x8080
#define OUT_VOL_RES                                   0x0080
...
//#define AUDIO_OUT_PACKET_SIZE_BYTES (uint32_t)(((USBD_AUDIO_FREQ * 2 * 2) / 1000))
#define AUDIO_OUT_PACKET_SIZE_BYTES 192

#define AUDIO_DEFAULT_VOLUME 90
#define AUDIO_DEFAULT_SAMPLERATE 48000

// 48 samples * 2 samples (stereo) * 2 buffers (double buffer)
#define AUDIO_BUFFER_SIZE_IN_SAMPLES 192
